module github.com/evroc-oss/cluster-api-provider-evroc/test/e2e
...
require (
	...
	sigs.k8s.io/cluster-api-operator v0.26.0 // indirect
	sigs.k8s.io/cluster-api-operator/test v0.26.0 // indirect
...
// Force rancher/turtles indirect dep to match the direct require version
replace github.com/rancher/turtles => github.com/rancher/turtles v0.26.0
